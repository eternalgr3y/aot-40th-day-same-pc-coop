@{
    ...
    Files = @(
        ...
        'profiles/b19-runtime-core-acceptance/profile.psd1'
        'profiles/b19-runtime-core-acceptance/daddy.arguments.template.txt'
        'profiles/b19-runtime-core-acceptance/cj.arguments.template.txt'
        'profiles/b19-runtime-core-acceptance/patches/454108D8 - coop-bind-6000.patch.toml'
        'profiles/b19-runtime-core-acceptance/patches/454108D8 - coop-cod-unaddressed.patch.toml'
        'profiles/b19-runtime-core-acceptance/patches/454108D8 - coop-hold-connecting-v2.patch.toml'

        'tools/runtime/AotPortableHardware.psm1'
        'tools/runtime/AotOwnedProcess.psm1'
        'tools/runtime/AotRuntimeCoreEvidence.psm1'
        ...
        'tests/test_aot_owned_process.ps1'
        'tests/test_aot_runtime_core_launch_plan.ps1'
        'tests/test_aot_runtime_core_log_watch.ps1'
        'tests/test_aot_runtime_core_sa2_evidence.ps1'
        'tests/test_initialize_aot_runtime_core_rigs.ps1'
